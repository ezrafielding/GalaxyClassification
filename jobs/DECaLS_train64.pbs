#!/bin/bash
#PBS -P ASTR1169
#PBS -N decals_train64
#PBS -l select=1:ncpus=20:ngpus=2
#PBS -l walltime=24:00:00
#PBS -q gpu_long
#PBS -m abe
#PBS -M 3869003@myuwc.ac.za
#PBS -o /mnt/lustre3p/groups/ASTR1169/GalaxyZoo/logs/decals_train64_output
#PBS -e /mnt/lustre3p/groups/ASTR1169/GalaxyZoo/logs/decals_train64_error
...
mv /mnt/lustre3p/groups/ASTR1169/GalaxyZoo/results /mnt/lustre3p/groups/ASTR1169/GalaxyZoo/trained_models/model_eff64
popd
